...
config :junto, JuntoWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "+zD8h+Zx7E8KKNE8oEirFofNUznhsxFWeQgPZf8fox8aankyLZ70uRG6yjxjDfRY",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:junto, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:junto, ~w(--watch)]}
  ]
...
config :junto, JuntoWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/junto_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :junto, dev_routes: true
