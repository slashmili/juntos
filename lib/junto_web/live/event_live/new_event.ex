defmodule JuntoWeb.EventLive.NewEvent do
  ...
  defp description(assigns) do
    ...
    <!-- Modal toggle -->
    <button
      data-modal-target="eventDescriptionModal"
      data-modal-toggle="eventDescriptionModal"
      class="flex flex-row gap-1 bg-black/5 pl-4 pt-1 pr-1 rounded-lg relative opacity-80 cursor-pointer pt-3 pb-3 select-none  hover-block-custom"
      type="button"
    >
      <div>
    ...
    <div
      ...
      tabindex="-1"
      aria-hidden="true"
      class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-10rem)] max-h-full"
    >
      <div class="relative p-4 w-full max-w-2xl max-h-full">
        <!-- Modal content -->
        <div class="relative bg-white shadow dark:bg-zinc-800 rounded-2xl">
          <!-- Modal header -->
          <div class="flex items-center justify-between rounded-t-2xl p-4 md:p-3 dark:bg-neutral-700 bg-neutral-100">
            ...
            <button
              ...
              data-modal-hide="eventDescriptionModal"
            >
          ...
          <!-- Modal footer -->
          <div class="flex items-center p-4 md:p-5 rounded-b-2xl border-gray-200  dark:border-gray-600  dark:bg-neutral-700 bg-neutral-100">
            <.button class="bg-black text-white rounded-lg font-medium px-3 py-2">Done</.button>
          </div>
        </div>
      </div>
    </div>
